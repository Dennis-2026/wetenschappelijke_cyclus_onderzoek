...
### Dit is een implementatie van item response theory per persoon zodat er een score en bijbehorend niveau uit valt te halen.
...
correction <- 0.3 # arbitraire waarde om meer uit te lijnen
